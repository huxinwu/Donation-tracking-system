    ...
    if(newsPage.records == null || newsPage.records.length === 0){
        ...
        for (let i = 0;i < newsPage.records.length;i++){
            html += "<div class=\"news-content\">\n" +
                ...
                "                            <a href=\"single-news.html?newsId="+newsPage.records[i].id+"\" class=\"btn gradient-bg\">Learn more</a>\n" +
                "                        </footer>\n" +
                "                    </div>";
        }
        //生成页码导航
...
//searchPublic interest headlines
