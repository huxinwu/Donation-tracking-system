...
function showCausesPage(causesPage) {
    ...
    if(causesPage.records == null || causesPage.records.length === 0){
        html += "<div align=\"center\" style=\"margin-top: 20%\"><h2>I'm sorry! The data you searched for was not found!</h2></div>";
    }else{
        //生成分页主体
        for (let i = 0;i < causesPage.records.length;i++){
            html += "<div class=\"news-content\">\n" +
                ...
                "                            <a href=\"single-causes.html?causeId="+causesPage.records[i].id+"\" class=\"btn gradient-bg\">Learn more</a>\n" +
                "                        </footer>\n" +
                "                    </div>";
        }
        //生成页码导航
...
function showFeatureCauses(causesArr) {
    ...
    //渲染页面
    let html = "";
    html += "<h2>Characteristic public welfare</h2>";
