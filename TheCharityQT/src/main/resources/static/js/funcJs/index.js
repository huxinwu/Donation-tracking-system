...
function showRecentlyCauses(causesArr) {
    ...
    html += "<div class=\"section-heading\">\n" +
        "    <h2 class=\"entry-title\">Recent charity events</h2>\n" +
        "</div>";
    for (let i = 0; i < causesArr.length;i++){
        html += "<div class=\"event-wrap d-flex flex-wrap justify-content-between\" >\n" +
            ...
            "                                    <a href=\"single-causes.html?causeId="+causesArr[i].id+"\">Learn more</a>\n" +
            "                                </div><!-- .entry-footer -->\n" +
...
//searchCharacteristic public welfare
...
//展示Characteristic public welfare
function showFeatureCauses(causesArr) {
    ...
    let html = "";
    html += "<div class=\"section-heading\">\n" +
        "       <h2 class=\"entry-title\">Characteristic public welfare</h2>\n" +
        "    </div><!-- .section-heading -->";
    html += "<div class=\"cause-wrap d-flex flex-wrap justify-content-between\">\n" +
        ...
        "                                    <a href=\"single-causes.html?causeId="+causesArr[0].id+"#donate\" class=\"btn gradient-bg mr-2\">Donate now</a>\n" +
        "                                </div><!-- .entry-footer -->\n" +
...
function showGoingCauses(causesArr) {
    ...
    for (let i = 0;i <causesArr.length;i++){
        ...
        html += "<div class=\"swiper-slide\">\n" +
            ...
            "                                            <a href=\"single-causes.html?causeId="+causesArr[i].id+"\" class=\"btn gradient-bg mr-2\">Donate now</a>\n" +
            "                                        </div><!-- .figure-overlay -->\n" +
            "                                    </figure>\n" +
            "\n" +
            "                                    <div class=\"cause-content-wrap\">\n" +
...
function showReachedGoal() {
    //展示Total funds raised
    showRaisedMoney();
    //展示completed  Charity project个数
