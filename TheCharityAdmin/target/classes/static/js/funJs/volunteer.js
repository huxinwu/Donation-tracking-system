...
function showEditInfo(id) {
    ...
    $.get(url,args,function(responseEntity) {
        if(responseEntity.result === "SUCCESS"){
            ...
            $("#edit_skill").empty();
            let html = "<option name =\"skills\">Please select your expertise:</option>";
    ...
    $.post(url,args,function(responseEntity){
        if(responseEntity.result=="SUCCESS"){
                ...
                if(responseEntity.data.records.length === 0){
                    html+="<tr><td colspan='9' align='center'>I'm sorry! The data you searched for was not found!</td></tr>"
                }else {
